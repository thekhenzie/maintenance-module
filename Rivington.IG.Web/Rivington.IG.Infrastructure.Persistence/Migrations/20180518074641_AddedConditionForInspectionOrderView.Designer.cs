...
namespace Rivington.IG.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20180518074641_AddedConditionForInspectionOrderView")]
    partial class addedconditionforinspectionorderview
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.DomesticHelp", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessment", b =>
                {
                    b.Property<Guid>("Id");

                    b.HasKey("Id");

                    b.ToTable("InspectionOrderNonWildfireAssessment");
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigation", b =>
                {
                    b.Property<Guid>("Id");

                    b.HasKey("Id");

                    b.ToTable("InspectionOrderNonWildfireAssessmentMitigation");
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigationRecommendations", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("InspectionOrderNonWildfireAssessmentMitigationId");

                    b.Property<byte[]>("Photo");

                    b.HasKey("Id");

                    b.HasIndex("InspectionOrderNonWildfireAssessmentMitigationId");

                    b.ToTable("InspectionOrderNonWildfireAssessmentMitigationRecommendations");
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigationRequirements", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("InspectionOrderNonWildfireAssessmentMitigationRequirements");
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNotes", b =>
                {
                    b.Property<Guid>("InspectionNotesId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyAdditionalExposure", b =>
                {
                    ...
                    b.HasIndex("CustomerOnSiteId")
                        .IsUnique()
                        .HasFilter("[CustomerOnSiteId] IS NOT NULL");

                    b.HasIndex("DogTemperamentId")
                        .IsUnique()
                        .HasFilter("[DogTemperamentId] IS NOT NULL");

                    b.HasIndex("Employee10HoursPerWeekId")
                        .IsUnique()
                        .HasFilter("[Employee10HoursPerWeekId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", b =>
                {
                    ...
                    b.Property<string>("DomesticHelpId");
                    ...
                    b.HasIndex("BurglarAlarmId")
                        .IsUnique()
                        .HasFilter("[BurglarAlarmId] IS NOT NULL");

                    b.HasIndex("BurglarAlarmTypeId")
                        .IsUnique()
                        .HasFilter("[BurglarAlarmTypeId] IS NOT NULL");

                    b.HasIndex("DomesticHelpId")
                        .IsUnique()
                        .HasFilter("[DomesticHelpId] IS NOT NULL");

                    b.HasIndex("FireAlarmId")
                        .IsUnique()
                        .HasFilter("[FireAlarmId] IS NOT NULL");

                    b.HasIndex("FireAlarmTypeId")
                        .IsUnique()
                        .HasFilter("[FireAlarmTypeId] IS NOT NULL");

                    b.HasIndex("OccupancyTypeId")
                        .IsUnique()
                        .HasFilter("[OccupancyTypeId] IS NOT NULL");

                    b.HasIndex("SmokeOnlyAlarmId")
                        .IsUnique()
                        .HasFilter("[SmokeOnlyAlarmId] IS NOT NULL");

                    b.HasIndex("SmokeOnlyAlarmTypeId")
                        .IsUnique()
                        .HasFilter("[SmokeOnlyAlarmTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueBath", b =>
                {
                    ...
                    b.Property<bool>("NumberofFullBath");

                    b.Property<bool>("NumberofHalfBath");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueFloorToCeiling", b =>
                {
                    ...
                    b.HasIndex("ChimneyTypeId")
                        .IsUnique()
                        .HasFilter("[ChimneyTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueInteriorFeatureInteriorDoorTypes", b =>
                {
                    ...
                    b.Property<string>("DomesticHelpTypeIdId");

                    b.HasKey("InspectionOrderPropertyHighValueInteriorFeatureId", "DomesticHelpTypeIdId");

                    b.HasIndex("DomesticHelpTypeIdId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", b =>
                {
                    ...
                    b.Property<int>("NumberofApplicance");

                    b.HasKey("Id");

                    b.HasIndex("ApplianceBrandId")
                        .IsUnique()
                        .HasFilter("[ApplianceBrandId] IS NOT NULL");

                    b.HasIndex("KitchenCabinetId")
                        .IsUnique()
                        .HasFilter("[KitchenCabinetId] IS NOT NULL");

                    b.HasIndex("KitchenCountertopId")
                        .IsUnique()
                        .HasFilter("[KitchenCountertopId] IS NOT NULL");

                    b.ToTable("InspectionOrderPropertyHighValueKitchen");
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchenApplianceTypes", b =>
                {
                    b.Property<Guid?>("InspectionOrderPropertyHighValueKitchenId");

                    b.Property<string>("ApplianceTypeId");

                    b.HasKey("InspectionOrderPropertyHighValueKitchenId", "ApplianceTypeId");

                    b.HasIndex("ApplianceTypeId")
                        .IsUnique();

                    b.ToTable("InspectionOrderPropertyHighValueKitchenApplianceTypes");
                });
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", b =>
                {
                    ...
                    b.HasIndex("ArchitecturalStyleId")
                        .IsUnique()
                        .HasFilter("[ArchitecturalStyleId] IS NOT NULL");

                    b.HasIndex("ConstructionQualityId")
                        .IsUnique()
                        .HasFilter("[ConstructionQualityId] IS NOT NULL");

                    b.HasIndex("FoundationTypeId")
                        .IsUnique()
                        .HasFilter("[FoundationTypeId] IS NOT NULL");

                    b.HasIndex("FramingTypeId")
                        .IsUnique()
                        .HasFilter("[FramingTypeId] IS NOT NULL");

                    b.HasIndex("HomeShapeId")
                        .IsUnique()
                        .HasFilter("[HomeShapeId] IS NOT NULL");

                    b.HasIndex("PrimaryExteriorWallCoveringId")
                        .IsUnique()
                        .HasFilter("[PrimaryExteriorWallCoveringId] IS NOT NULL");

                    b.HasIndex("PrimaryRoofCoveringId")
                        .IsUnique()
                        .HasFilter("[PrimaryRoofCoveringId] IS NOT NULL");

                    b.HasIndex("RoofTypeId")
                        .IsUnique()
                        .HasFilter("[RoofTypeId] IS NOT NULL");

                    b.HasIndex("SecondaryExteriorWallCoveringId")
                        .IsUnique()
                        .HasFilter("[SecondaryExteriorWallCoveringId] IS NOT NULL");

                    b.HasIndex("SecondaryRoofCoveringId")
                        .IsUnique()
                        .HasFilter("[SecondaryRoofCoveringId] IS NOT NULL");

                    b.HasIndex("SlopeOfSiteId")
                        .IsUnique()
                        .HasFilter("[SlopeOfSiteId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyPhotoPhotos", b =>
                {
                    ...
                    b.HasKey("InspectionOrderPropertyPhotoId", "Id");

                    b.HasAlternateKey("Id");

                    b.HasIndex("PhotoTypeId")
                        .IsUnique()
                        .HasFilter("[PhotoTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentAccessAndFireProtection", b =>
                {
                    ...
                    b.HasIndex("FireDepartmentStaffingId")
                        .IsUnique()
                        .HasFilter("[FireDepartmentStaffingId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentMitigationRecommendations", b =>
                {
                    ...
                    b.HasIndex("InspectionOrderWildfireAssessmentMitigationId");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", b =>
                {
                    ...
                    b.HasIndex("EavesTypeId")
                        .IsUnique()
                        .HasFilter("[EavesTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessment", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InspectionOrder", "InspectionOrder")
                        ...
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessment", "Id")
                        .HasConstraintName("FK_InspectionOrderNonWildfireAssessment_InspectionOrder")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigation", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessment", "InspectionOrderNonWildfireAssessment")
                        .WithOne("Mitigation")
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigation", "Id")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigationRecommendations", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigation", "InspectionOrderNonWildfireAssessmentMitigation")
                        .WithMany("Recommendations")
                        .HasForeignKey("InspectionOrderNonWildfireAssessmentMitigationId")
                        .HasConstraintName("FK_IoNwaMitigationRecommendations_InspectionOrderNonWildfireAssessmentMitigation")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigationRequirements", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderNonWildfireAssessmentMitigation", "InspectionOrderNonWildfireAssessmentMitigation")
                        ...
                        .HasForeignKey("InspectionOrderNonWildfireAssessmentMitigationId")
                        .HasConstraintName("FK_IoNwaMitigationRequirements_InspectionOrderNonWildfireAssessmentMitigation")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyAdditionalExposure", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.CustomerOnSite", "CustomerOnSite")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyAdditionalExposure", "CustomerOnSiteId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.DogTemperament", "DogTemperament")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyAdditionalExposure", "DogTemperamentId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.Employee10HoursPerWeek", "Employee10HoursPerWeek")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyAdditionalExposure", "Employee10HoursPerWeekId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.BurglarAlarm", "BurglarAlarm")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "BurglarAlarmId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.BurglarAlarmType", "BurglarAlarmType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "BurglarAlarmTypeId")
                        .HasConstraintName("FK_InspectionOrderPropertyGeneral_BurglarAlarmType");

                    b.HasOne("Rivington.IG.Domain.Models.DomesticHelp", "DomesticHelp")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "DomesticHelpId")
                        .HasConstraintName("FK_InspectionOrderPropertyGeneral_DomesticHelp");

                    b.HasOne("Rivington.IG.Domain.Models.FireAlarm", "FireAlarm")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "FireAlarmId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.FireAlarmType", "FireAlarmType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "FireAlarmTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.OccupancyType", "OccupancyType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "OccupancyTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.SmokeOnlyAlarm", "SmokeOnlyAlarm")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "SmokeOnlyAlarmId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.SmokeOnlyAlarmType", "SmokeOnlyAlarmType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "SmokeOnlyAlarmTypeId")
                        .HasConstraintName("FK_InspectionOrderPropertyGeneral_SmokeOnlyAlarmType");

                    b.HasOne("Rivington.IG.Domain.Models.State", "State")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyGeneral", "StateId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueFloorToCeiling", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.ChimneyType", "ChimneyType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueFloorToCeiling", "ChimneyTypeId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueInteriorFeatureInteriorDoorTypes", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InteriorDoorType", "InteriorDoorType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueInteriorFeatureInteriorDoorTypes", "DomesticHelpTypeIdId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.ApplianceBrand", "ApplianceBrand")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", "ApplianceBrandId")
                        .HasConstraintName("FK_InspectionOrderPropertyHighValueKitchen_ApplianceBrand");
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.KitchenCabinet", "KitchenCabinet")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", "KitchenCabinetId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.KitchenCountertop", "KitchenCountertop")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", "KitchenCountertopId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchenApplianceTypes", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.ApplianceType", "ApplianceType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchenApplianceTypes", "ApplianceTypeId")
                        .HasConstraintName("FK_InspectionOrderPropertyHighValueKitchenApplianceTypes_ApplianceType")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHighValueKitchen", "InspectionOrderPropertyHighValueKitchen")
                        .WithMany("ApplianceTypes")
                        .HasForeignKey("InspectionOrderPropertyHighValueKitchenId")
                        .HasConstraintName("FK_InspectionOrderPropertyHighValueKitchenApplianceTypes_InspectionOrderPropertyHighValueKitchen")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.ArchitecturalStyle", "ArchitecturalStyle")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "ArchitecturalStyleId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.ConstructionQuality", "ConstructionQuality")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "ConstructionQualityId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.FoundationType", "FoundationType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "FoundationTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.FramingType", "FramingType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "FramingTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.HomeShape", "HomeShape")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "HomeShapeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.PrimaryExteriorWallCovering", "PrimaryExteriorWallCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "PrimaryExteriorWallCoveringId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.PrimaryRoofCovering", "PrimaryRoofCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "PrimaryRoofCoveringId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.RoofType", "RoofType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "RoofTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.SecondaryExteriorWallCovering", "SecondaryExteriorWallCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "SecondaryExteriorWallCoveringId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.SecondaryRoofCovering", "SecondaryRoofCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "SecondaryRoofCoveringId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.SlopeOfSite", "SlopeOfSite")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderPropertyHomeDetail", "SlopeOfSiteId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentAccessAndFireProtection", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.FireDepartmentStaffing", "FireDepartmentStaffing")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentAccessAndFireProtection", "FireDepartmentStaffingId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentExteriorSiding", b =>
                {
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.PrimaryExteriorWallCovering", "PrimaryExteriorWallCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentExteriorSiding", "PrimaryExteriorWallCoveringId")
                        .HasConstraintName("FK_IoWaExteriorSiding_PrimaryExteriorWallCovering");

                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.SecondaryExteriorWallCovering", "SecondaryExteriorWallCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentExteriorSiding", "SecondaryExteriorWallCoveringId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentFoundationToFrame", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.FoundationType", "FoundationType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentFoundationToFrame", "FoundationTypeId")
                        .HasConstraintName("FK_IoWaFoundationToFrame_FoundationType");

                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.FramingType", "FramingType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentFoundationToFrame", "FramingTypeId")
            ...
            modelBuilder.Entity("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", b =>
                {
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.EavesType", "EavesType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", "EavesTypeId")
                    ...
                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.PrimaryRoofCovering", "PrimaryRoofCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", "PrimaryRoofCoveringId")
                        .HasConstraintName("FK_IoWaRoof_PrimaryRoofCovering");

                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.RoofType", "RoofType")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", "RoofTypeId")
                        .HasConstraintName("FK_IoWaRoof_RoofType");

                    b.HasOne("Rivington.IG.Domain.Models.OrderManagement.SecondaryRoofCovering", "SecondaryRoofCovering")
                        .WithOne()
                        .HasForeignKey("Rivington.IG.Domain.Models.OrderManagement.InspectionOrderWildfireAssessmentRoof", "SecondaryRoofCoveringId")
