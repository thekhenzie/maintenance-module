...
{
    public class InspectionOrderWildfireAssessmentChildMitigationRecommendationsRepository: RepositoryBase<InspectionOrderWildfireAssessmentChildMitigationRecommendations>,
        IInspectionOrderWildfireAssessmentChildMitigationRecommendationsRepository
    {
        ...
        public InspectionOrderWildfireAssessmentChildMitigationRecommendationsRepository(
        ...
        {
            return context.Set<InspectionOrderWildfireAssessmentChildMitigationRecommendations>()
                    .Count(m => m.IoWaParentMitigationRecommendationsId == parentId);
